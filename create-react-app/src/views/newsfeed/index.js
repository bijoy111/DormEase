...
import newsfeed_pic from 'assets/images/notice_demo.png';
...
const SamplePage = () => {
  ...
  return (
    <section className="newsfeed-section" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh',backgroundColor: '#f4f5ff',borderRadius: '18px' }}>
      <div className="card" style={{ maxWidth: '62rem' }}>
        <div className="card-body">
          ...
          <div>
            <p>
              The Bangladesh University of Engineering and Technology (BUET) is one of the most prestigious institutions for higher education in Bangladesh, particularly in the field of engineering and architecture. 
            </p>
          </div>
        </div>
        ...
        <div className="d-flex align-items-center">
          ...
          <span>{votes}</span>
          <button onClick={handleDownvote} style={{ marginLeft: '8px', marginRight: '428px' }}>
            ...
            <div  style={{ marginLeft: '8px',backgroundColor: '#d3d3d3', padding: '10px', borderRadius: '8px' }}>
              <div className="bg-light rounded-3 px-3 py-1">
                ...
                <br/>
                  ...
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Natus, aspernatur!Lorem ipsum dolor sit amet consectetur, adipisicing elit. Natus, aspernatur!
                  </small>
              </div>
              <strong>Reply</strong>
            </div>
